...
export type RefundRequestBody = components["schemas"]["RefundRequestBody"];
export type RefundRequestList = components["schemas"]["RefundRequestList"];
...
export type PaymentMethodData = components["schemas"]["PaymentMethod"];
export type ProductData = components["schemas"]["Product"];
export type ProjectData = components["schemas"]["ProjectDetail"];
export type RefundRequestData = components["schemas"]["RefundRequest"];
...
export type PaymentMethodSummary = components["schemas"]["PaymentMethod"];
export type ProductSummary = components["schemas"]["Product"];
export type ProjectSummary = components["schemas"]["Project"];
export type RefundRequestSummary = components["schemas"]["RefundRequest"];
