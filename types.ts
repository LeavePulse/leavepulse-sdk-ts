...
export interface components {
	schemas: {
		...
		/** LinkSession */
		LinkSession: {
			already_linked_project_id?: number | null;
			expires_at: string;
			guild_id: string;
			guild_name?: string | null;
		...
		ServerTeamPublic: {
			enabled: boolean;
			inherited_from_server_id?: number | null;
